...
DROP DATABASE DATA_ANALYSIS_IN_SCOTLAND;
USE DATABASE DATA_ANALYSIS_IN_SCOTLAND;
UNDROP DATABASE DATA_ANALYSIS_IN_SCOTLAND;
USE DATABASE DATA_ANALYSIS_IN_SCOTLAND;
USE SCHEMA CURATED;
SELECT * FROM CASUALTIES_BY_HEALTH_BOARD;
...
CREATE DATABASE DATA_ANALYSIS_IN_SCOTLAND_TEST CLONE DATA_ANALYSIS_IN_SCOTLAND;